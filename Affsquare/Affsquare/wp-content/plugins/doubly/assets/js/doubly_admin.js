...
function UniteAdminDOUBLY(){
	...
	var g_providerAdmin = new UniteProviderAdminDOUBLY(), g_dialogActivation;
	...
	this.getUrlAjax = function(action, params){
		...
		var url = g_urlAjaxActionsDOUBLY;
		
		url = t.addUrlParam(url, "action", "doubly_ajax_actions");
	...
	this.ajaxRequest = function(action,data,successFunction){
		...
		if(typeof data.append == "function"){
			isRawMode = true;
			var objData = data;
			objData.append("action", "doubly_ajax_actions");
